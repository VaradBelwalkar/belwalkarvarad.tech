---
title: "AWS-CLI Commands to work with Localstack"
date: 2023-11-09T09:15:19+05:30
draft: false
ShowToc: false
ShowRelatedContent: true
summary: "Comprehensive list of AWS-CLI commands to work with Localstack"
...
To configure to use Localstack, you simply need to do the following, where replace the URL with the one provided by the localstack when you ran it.
If you want to setup localstack first, visit [here]()
